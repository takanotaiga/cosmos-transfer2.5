...
from cosmos_transfer2._src.predict2.camera.configs.camera_conditioned.conditioner import register_conditioner
from cosmos_transfer2._src.predict2.camera.configs.camera_conditioned.data import register_camera_data
from cosmos_transfer2._src.predict2.camera.configs.camera_conditioned.model import register_model
from cosmos_transfer2._src.predict2.camera.configs.camera_conditioned.net import register_net
...
def make_config() -> Config:
    ...
    import_all_modules_from_package(
        "cosmos_transfer2._src.predict2.camera.configs.camera_conditioned.experiment", reload=True
    )
    return c
