...
from cosmos_transfer2._src.predict2.camera.networks.camera_conditioned_ar_minimal_v1_lvg_dit import (
    CameraConditionedARMinimalV1LVGDiT,
)
from cosmos_transfer2._src.predict2.camera.networks.camera_conditioned_minimal_v1_lvg_dit import (
    CameraConditionedMinimalV1LVGDiT,
)
from cosmos_transfer2._src.predict2.camera.networks.minimal_v4_dit_camera_conditioned import SACConfig

# ------------------------------------------------------------
# Camera Conditioned
# ------------------------------------------------------------

CAMERA_COSMOS_V1_7B_NET_MININET: LazyDict = L(CameraConditionedMinimalV1LVGDiT)(
    max_img_h=240,
    max_img_w=240,
    max_frames=128,
    in_channels=16,
...
CAMERA_COSMOS_AR_V1_7B_NET_MININET: LazyDict = L(CameraConditionedARMinimalV1LVGDiT)(
    max_img_h=240,
    max_img_w=240,
    max_frames=128,
    in_channels=16,
