...
from cosmos_transfer2._src.predict2.action.configs.action_conditioned.conditioner import register_conditioner
from cosmos_transfer2._src.predict2.action.configs.action_conditioned.data import register_training_and_val_data
from cosmos_transfer2._src.predict2.action.configs.action_conditioned.model import register_model
from cosmos_transfer2._src.predict2.action.configs.action_conditioned.net import register_net
...
from cosmos_transfer2._src.predict2.configs.video2world.defaults.callbacks import register_callbacks
...
def make_config() -> Config:
    ...
    import_all_modules_from_package(
        "cosmos_transfer2._src.predict2.action.configs.action_conditioned.experiment", reload=True
    )
