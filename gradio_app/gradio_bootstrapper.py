...
from cosmos_transfer2.control2world import Control2World_Inference, Control2World_Params
from cosmos_transfer2.multiview import Multiview_Inference, Multiview_Params
...
def create_control2world(hint_key: str):
    ...
    pipeline = Control2World_Inference(
        num_gpus=global_env.num_gpus, checkpoint_dir=global_env.checkpoint_dir, hint_key=hint_key
    )
    gc.collect()
...
if __name__ == "__main__":
    ...
    factory_module = {
        "vis": "gradio_app.gradio_bootstrapper",
        "depth": "gradio_app.gradio_bootstrapper",
        "edge": "gradio_app.gradio_bootstrapper",
        "seg": "gradio_app.gradio_bootstrapper",
    ...
    validators = {
        "vis": Control2World_Params.validate_kwargs,
        "depth": Control2World_Params.validate_kwargs,
        "edge": Control2World_Params.validate_kwargs,
        "seg": Control2World_Params.validate_kwargs,
