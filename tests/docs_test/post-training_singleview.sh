...
export DATASET_DIR="$INPUT_DIR/assets/singleview_posttrain_dataset_VideoUFO_subsample"
...
CHECKPOINTS_DIR="${IMAGINAIRE_OUTPUT_ROOT}/cosmos_transfer2_posttrain/local_single_view/transfer2_singleview_posttrain_edge_example/checkpoints"
